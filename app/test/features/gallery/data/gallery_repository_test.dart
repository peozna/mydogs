...
void main() {
  group('GalleryRepository Unit Tests', () {
    ...
    test('saveDog downloads the image and saves metadata successfully', () async {
      ...
      final dogImage = DogImage(
        ...
        height: 400,
        breeds: [
          const Breed(id: '1', name: 'Golden Retriever'),
        ],
      );
    ...
    test('saveDog cleans up local file if SharedPreferences write fails', () async {
      SharedPreferences.setMockInitialValues({});
    ...
    test('deleteDog deletes local file and removes metadata from SharedPreferences', () async {
      final savedDog = SavedDog(
        ...
        height: 500,
        breeds: [
          const Breed(id: '2', name: 'Siberian Husky'),
        ],
    ...
    test('deleteDog cleans metadata even if local file deletion fails (missing file)', () async {
      final savedDog = SavedDog(
        id: 'husky_123',
        localImagePath: '/fake/path/dog_husky_123.jpg',
        url: 'https://example.com/husky.jpg',
